...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks =  -1144.7556988729036; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -3675.1154027908597; // x position of the perpendicular encoder (in tick units)
    }
